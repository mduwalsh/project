...
and finite populations may get attracted to those near fixed points(see \cite{Vose1999}). 
...
between different pairs of points, which occurred in diploid populations only in our simulations. 
