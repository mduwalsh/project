...
% figures for chi violation
\input{chapters/vio-chi-table.tex}
...
Then we studied through simulations the effect of violating the condition 
for convergence to periodic orbits on infinite and finite population.
