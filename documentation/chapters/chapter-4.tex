...
The violation of the condition \ref{OscCond} results the absence of convergence of 
infinite population to a periodic orbit.
...
This means no periodic orbit exists for finite population, 
and oscillation of finite population should not occur. 
Can finite populations exhibit approximate oscillation when the
