...
finite populations (see \cite{CrowKimura}). And partly because as generation increases, 
difference between actual finite population and infinite population accumulates 
...
Red node represents finite population point and blue node represents infinite population point. 
Each edge connects one generation to next, red edge denotes finite population path, 
and blue edge denotes infinite population path from each node}
\label{nonlinear}
\end{center}
\end{figure}
