...
\begin{document}
  ...
  \begin{frame}
    \frametitle{Background: Crossover \& Mutation}    
    \begin{itemize}    
  ...
  \begin{frame}
    \frametitle{Background: Finite Population GA}
    \begin{columns}
  ...
  \begin{frame}
    \frametitle{Background: Random Heuristic Search}
    {\setstretch{2.0}
    \begin{itemize}    
  ...
  \begin{frame}
    \frametitle{Background: Infinite Population Model}
    \begin{itemize}
  ...
  \begin{frame}
    \frametitle{Computations: Diploid Population Model}
    \begin{itemize}
  ...
  \begin{frame}
    \frametitle{Computations: Diploid Model Reduction to Haploid Model}
    {\setstretch{0.8}
    \begin{itemize}
      \item{ \mbox{}\\[0.1in]
  ...
  \begin{frame}
    \frametitle{Computations: Specialization to Vose's Haploid Model}
    \begin{itemize}
  ...
  \begin{frame}
    \frametitle{Computations: Walsh Basis}
    \begin{itemize}
  ...
  \begin{frame}
    \frametitle{Computations: Computational Advantages}
    \begin{itemize}
      \item{\vspace{-0.5in}
  ...
  \begin{frame}
    \frametitle{Computations: Distance}
    \begin{itemize}      
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item Does the distance between finite and infinite population decrease like $1/\sqrt{N}$ ?
      \item Yes
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}      
      \setlength\itemsep{1em}
      \item{Approximate oscillation is exhibited when mutation-violation is small}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \setlength\itemsep{1em}
      \item{Approximate oscillation is exhibited when crossover-violation is small} 
      \item{If violation is large, then oscillation decreases}      
      \item{More randomness is observed with violation in crossover than in mutation}
