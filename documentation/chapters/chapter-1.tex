...
Haldane, in the classic book `The Causes Of Evolution', presents summary of the basic models of population genetics 
...
However, the study was simple and limited to two loci and two alleles. 
...
Also works of Wright and Bidwell, and Wright and Agapie focus only on haploid population evolution 
whereas we consider both haploid and diploid population evolutions.
Moreover, our research studies cyclic behavior for a different slice of fitness   
...
We find cycles in both finite and infinite population evolution, and provide visualization related to infinite population fixed points. 
We investigate finite population oscillation with experiments 
in Chapter 3. 
}
...
But our work, the condition for infinite population evolution to converge to periodic orbits depends upon crossover (see \cite{Vose1999}). 
