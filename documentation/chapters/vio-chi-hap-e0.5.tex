...
Unlike in case of mutation distribution with violation with $\bm{\epsilon} \;=\; 0.5$, absence of oscillation is not observed. 
Finite populations still show some oscillation though not very clear oscillations, and infinite populations also oscillate but completely dies out quickly. 
