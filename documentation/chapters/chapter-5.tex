...
The results from chapter \ref{ch:muviolation} show robustness of finite population
demonstrating approximate oscillation occurrence in finite population
when the mutation distribution $\bm{\mu}$ violates the condition \ref{OscCond} .  
