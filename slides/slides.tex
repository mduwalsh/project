...
%     \newline
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item{Oscillations Under Violation in Mutation}      
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item{Necessary condition for mutation distribution is violated so that no periodic orbit exists for infinite population} 
      \item{Violation makes Markov chain regular so that no periodic orbit exists for finite population}
  ...
  \end{frame}
   ...
   \begin{frame}
    ...
    \begin{itemize}
      \item{Oscillations under Violation in Crossover }      
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item{But we don't know if Markov chain is regular}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item{Finite population exhibits approximate oscillation if the violation is small} 
      \item{If violation is large, then finite population oscillation decreases}
      \item{Rate of damping of oscillation is slower than in violation in mutation case}
