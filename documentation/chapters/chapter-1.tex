...
The first research question to be investigate is whether that rate of decrease is exhibited 
...
finite populations might also show oscillating behavior. The second research question to be investigated is whether such finite population 
...
If transition matrix $Q$ is irreducible and non-negative, then the Markov chian is 
...
Therefore, oscillation cannot occur. In Chapter 4, we investigate oscillation behavior of 
finite populations when the Markov chain is erfogic. That is the third research question.
