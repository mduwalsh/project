...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      \item 
      \centering
      \resizebox*{7cm}{!}{\includegraphics{figures/eps/vio/mu/b8/e0.1/inf_dip_wovio.eps}}  
      \item Tests show $\bm{z}^\ast$ is between and equidistant from $\bm{p}^\ast$ and $\bm{q}^\ast$
    \end{itemize}
  \end{frame}
