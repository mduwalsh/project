...
oscillating behavior of both infinite and finite populations when condition \ref{OscCond} is met. 
...
Also amplitude of oscillations decreases with increase in $\ell$ value for same population size, 
and thus, amplitude of oscillations of diploid population is larger than haploid population of same population size and same value of $\ell$. 
