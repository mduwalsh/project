...
Akin (1981) analytically proves the existence of cycling for the continuous-time diploid two allele model. 
Hastings (see \cite{Hastings1981}) used numerical approach to study 
the behavior of the cycling populations with infinite diploid population model. 
...
Wright and Bidwell (see \cite{Wright1997}) provided examples when cycles in infinite population occur with mutation and 
crossover for 3 and 4 bit population to prove existence of cycling behavior. Different behavior cases were observed. 
...
This research studies oscillation for higher bit string lengths. 
...
And more importantly, we study and analyse oscillation in finite population.

The second research question to consider is whether such finite population 
