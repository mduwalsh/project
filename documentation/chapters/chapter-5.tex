...
\begin{table}[ht]
\caption{Expected distance $d$ for population size $N$}
\centering
...
Distances of finite population of size $N = \{4096, 40960, 81920\}$ to infinite population obtained from simulation for oscillation 
without violation for both haploid and dioploid case with genome length $\ell = \{8, 10, 12, 14\}$ are tabulated below.
...
$N$ & $\ell$ & case & $d^\prime$
\hline
\multirow{8}{*}{4096} & \multirow{2}{*}{8} 	& haploid & 0.0159 \\
		      &   			& diploid & 0.0157 \\
		      & \multirow{2}{*}{10} 	& haploid & 0.016 \\
		      &  	 		& diploid & 0.0157 \\
		      & \multirow{2}{*}{12} 	& haploid & 0.0158 \\
		      &  	 		& diploid & 0.0157 \\
		      & \multirow{2}{*}{14} 	& haploid & 0.0158 \\
		      &  	 		& diploid & 0.0156 \\
\multirow{8}{*}{40960} & \multirow{2}{*}{8} 	& haploid & 0.0055 \\
		      &   			& diploid & 0.005 \\
		      & \multirow{2}{*}{10} 	& haploid & 0.005 \\
		      &  	 		& diploid & 0.005 \\
		      & \multirow{2}{*}{12} 	& haploid & 0.005 \\
		      &  	 		& diploid & 0.005 \\
		      & \multirow{2}{*}{14} 	& haploid & 0.005 \\
		      &  	 		& diploid & 0.0049 \\
\multirow{8}{*}{81920} & \multirow{2}{*}{8} 	& haploid & 0.0038 \\
		      &   			& diploid & 0.0036 \\
		      & \multirow{2}{*}{10} 	& haploid & 0.0038 \\
		      &  	 		& diploid & 0.0035 \\
		      & \multirow{2}{*}{12} 	& haploid & 0.0035 \\
		      &  	 		& diploid & 0.0035 \\
		      & \multirow{2}{*}{14} 	& haploid & 0.0035 \\
		      &  	 		& diploid & 0.0035 \\
