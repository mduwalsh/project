...
shows distance of finite and infinite haploid populations with $\bm{\epsilon} \;=\; 0.5$ to non-violation limits $\bm{p^\ast}$ and $\bm{q^\ast}$. 
Compared to mutation with violation $\bm{\epsilon} \;=\; 0.5$, oscillation is observed for more generations. 
Finite populations still show some, though not very clear, oscillations, and then show randomness in behavior as generations progress. 
The oscillation in infinite population dies out quickly. Randomness in finite population behavior increases 
...
shows distance of finite and infinite haploid populations with $\bm{\epsilon} \;=\; 0.5$ to limit $\bm{z^\ast}$ 
